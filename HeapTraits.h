...
template<typename Heap>
constexpr inline bool IsDecreaseableHeapV = detail::isDecreaseableHeap<Heap>(0).value;

template<typename Heap>
constexpr inline bool IsMergeableHeapV = detail::isMergeableHeap<Heap>(0).value;
